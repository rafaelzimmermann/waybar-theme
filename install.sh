...
echo ""
echo "NOTE: This script only installs the waybar config. Configure Hyprland"
echo "      (workspace rules, monitors, autostart of waybar, etc.) in your own"
echo "      ~/.config/hypr/hyprland.conf — a waybar theme should not own that."
echo ""
echo "Done."
